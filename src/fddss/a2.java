...
public class a2 extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(request.getSession().getAttribute("aaaa") != null && request.getSession().getAttribute("aaaa").equals("123")){
		out.print("<html><body><form action = \"HelloWorld\" method=\"Get\">");
		out.print("年：<input type = text name = y></br>");
		out.print("月：<input type = text name = m></br>");
		out.print("<input type = submit value = 送出>");
		out.print("</form><form action = \"logioout\" method=\"Get\">");
